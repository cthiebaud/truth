...
* `S` <img src="svg/b-shuffle.svg" class="qwe" style="width: auto; height: 16px;">&nbsp;&nbsp;&nbsp;[swipe vers la droite]&nbsp;Mélange les tables aléatoirement.
* `O` [swipe vers la gauche]&nbsp;Trie les tables par nombre de briques en ordre croissant, ou mélange les couleurs si les tables sont déjà triées.
