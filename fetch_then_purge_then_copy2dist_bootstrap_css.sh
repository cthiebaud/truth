...
# purgecss --css <(curl -k https://cdn.jsdelivr.net/npm/bootstrap@latest/dist/css/bootstrap.mincss -o -) --content index.html--output dist/css/bootstrap.min.css
# curl -k https://cdn.jsdelivr.net/npm/bootstrap@latest/dist/css/bootstrap.css -o dist/css/bootstrap.css